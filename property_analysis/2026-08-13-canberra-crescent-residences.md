...
The reconciliation keeps the agent-reported sold date, portal transaction date and URA sale month as separate concepts. It remains noncanonical research: URA's public record does not disclose exact unit numbers, and ambiguous matches are deliberately not forced.
