...
# Estate name -> HDB town mapping.
HDB_TOWN_ALIAS: Dict[str, str] = {
    "CANBERRA":      "SEMBAWANG",
...
# Names that appear in pipeline_data.json -> canonical estate names.
PIPELINE_ESTATE_ALIAS: Dict[str, str] = {
    "BIDADARI":       "WOODLEIGH",
    "MARSILING":      "WOODLANDS",
    "KAKI BUKIT":     "BEDOK",
